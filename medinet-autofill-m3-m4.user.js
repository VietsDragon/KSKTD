    ...
    const CAN_LAM_SANG_REFERENCE = [
        {
            ...
            low: { code: 'D64.9', name: 'Thiếu máu chưa xác định, Bỏ qua nếu gần khoảng giới hạn bình thường' },
            high: { code: 'D75.1', name: 'Đa hồng cầu thứ phát, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
            ...
            low: { code: 'D64.9', name: 'Thiếu máu, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
            ...
            low: { code: 'D64.9', name: 'Thiếu máu, Bỏ qua nếu gần khoảng giới hạn bình thường' },
            high: { code: 'D75.1', name: 'Đa hồng cầu, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
            column: 'MCV', label: 'MCV',
            min: 85, max: 95,
            low: { code: 'D50.9', name: 'Thiếu máu hồng cầu nhỏ (gợi ý thiếu sắt), Bỏ qua nếu gần khoảng giới hạn bình thường' },
            high: { code: 'D53.9', name: 'Thiếu máu hồng cầu to, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        ...
        { column: 'RDW', label: 'RDW', min: 10, max: 16.5 },
        {
            ...
            min: 4.0, max: 10.0,
            low: { code: 'D72.8', name: 'Giảm bạch cầu', Bỏ qua nếu gần khoảng giới hạn bình thường },
            high: { code: 'D72.8', name: 'Tăng bạch cầu', Bỏ qua nếu gần khoảng giới hạn bình thường }
        },
        ...
        { column: 'MONO#', label: 'BC đơn nhân', min: 0.1, max: 1.0 },
        {
            ...
            min: 0.0, max: 0.5,
            high: { code: 'D72.1', name: 'Tăng bạch cầu ái toan, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        { column: 'BASO#', label: 'BC ái kiềm', min: 0.0, max: 0.1 },
        {
            column: 'PLT', label: 'Tiểu cầu',
            min: 150, max: 400,
            low: { code: 'D69.6', name: 'Giảm tiểu cầu, Bỏ qua nếu gần khoảng giới hạn bình thường' },
            high: { code: 'D75.2', name: 'Tăng tiểu cầu, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
            column: 'Glucose', label: 'Đường máu',
            min: 3.9, max: 5.5,
            low: { code: 'E16.2', name: 'Hạ đường huyết, Bỏ qua nếu gần khoảng giới hạn bình thường' },
            high: { code: 'R73.9', name: 'Tăng đường huyết - theo dõi đái tháo đường, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
            column: 'Ure', label: 'Urê',
            min: 2.5, max: 7.5,
            high: { code: 'R79.8', name: 'Tăng ure máu, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
            ...
            high: { code: 'R94.4', name: 'Chức năng thận bất thường, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
            ...
            high: { code: 'R74.0', name: 'Tăng men gan, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
        ...
        { column: 'pH', label: 'pH nước tiểu', min: 5.0, max: 8.0 },
        {
            ...
            min: 0, max: 0,
            high: { code: 'N39.0', name: 'Nhiễm khuẩn đường tiết niệu, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
            column: 'BLD', label: 'Hồng cầu niệu',
            min: 0, max: 0,
            high: { code: 'R31', name: 'Tiểu máu, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
            column: 'PRO', label: 'Protein niệu',
            min: 0, max: 0,
            high: { code: 'R80', name: 'Protein niệu, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
            column: 'GLU', label: 'Glucose niệu',
            min: 0, max: 0,
            high: { code: 'R81', name: 'Đường niệu, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
            column: 'KET', label: 'Thể cetonic niệu',
            min: 0, max: 0,
            high: { code: 'R82.4', name: 'Ceton niệu, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
            column: 'BIL', label: 'Bilirubin niệu',
            min: 0, max: 0,
            high: { code: 'R82.2', name: 'Bilirubin niệu, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        },
        {
            column: 'URO', label: 'Urobilinogen niệu',
            min: 0, max: 17,
            high: { code: 'R82.2', name: 'Tăng urobilinogen niệu, Bỏ qua nếu gần khoảng giới hạn bình thường' }
        }
    ];
